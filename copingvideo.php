<?php 
  ...
  $qry="select * from sas_copvideos where id=".$_REQUEST['id'];
	...
	if(userid == null || userid==""){
	  document.getElementById('abc3').style.display = "block";
		...
		success: function(html){ //alert('count='+html)
			...
			if(rel2=='Like')
			{ //alert(rel2+'==Like')        		
			  $('#'+ID).attr('rel', 'Unlike').attr('title', 'Unlike').html('Video Like');
			  $("#likescnt").html(html)
...
<div id="container">
	...
	<div id="wrapp">
        ...
        <section class="one-half1">
		 ...
		 <iframe src="//player.vimeo.com/video/<?php echo $vcode;?>" width="100%" height="auto" frameborder="0" ></iframe></a>
        ...
        <div id="breadcrumb"><!-- breadcrumb starts-->
				...
				<?php
					...
					//print_r($rlt2);
					extract($rlt2); //echo $copvlc=$rlt2['like_count'];
					$catid=$cat_id; 
			    ...
			    ?>
						<h4><?php echo $videono .' : '. $prod_name;?></h4>
					<?php }?>	
					</div>
					<div class="one-half">
		  ...
		  <div class="container">
		   ...
		   <div class="theme-desc-header-right">				
			  ...
			  <div class="theme-timeline" >
				<p><a href="video-comments.php?cid=<?php echo $_REQUEST['cid']?>&vid=<?php echo $_REQUEST['pid'];?>"><img src="images/discuss_button.png"></a><p> 
			  </div>
			  -->
			 </div>
		    </div> 
			 ...
			 <div class="tag2">
				...
				<?php
				 ...
				 {		 
					extract($rlt);
				?>
				<li><a data-id="<?php echo $id; ?>" href="#"><img src="https://s3-us-west-2.amazonaws.com/sas-characterphotos/<?php echo $photopath;?>" width="100" height="100"></a></li>
			   ...
			   <?php  } ?>
				...
				<div  id="popuptext" style="display:none;"> 
				  ...
				  <h3 id="pro-title"><?php echo $title;?></h4>
				   <img id="pro-img" src="character_photos/<?php echo $photopath;?>" width="200" height="200">
				   <div id="pro-desc">
				   </div>
				   ...
				   <script>
					 $(document).ready(function(){
						...
						<form id="popupform" action="#" method="post" id="form" >
							...
							<h6 style="padding-top: 8px;font-size: 14px;line-height: 7px;color:#005292;">Please login to like this video!</h6><hr/>
				   ...
				   <script>
					 $(document).ready(function(){
						...
						<form id="popupform" action="#" method="post" id="form" >
							...
							<h6 style="padding-top: 8px;font-size: 14px;line-height: 7px;color:#005292;">Please login to answer this questionnaire !</h6><hr/>
				   ...
				   <div >
				     ...
				     <script>					  
						...
						function ansfun2() {
							...
							//alert(id)
							$.post("validateanswrs.php?a="+a+"&cid="+cid+"&id=4&vtype=cvideo",{},function(data){
                    ...
                    <?php 
			          ...
			          //$rs=mysql_query("SELECT * FROM sas_quiz where cpvid=".$_REQUEST['id']." and status='1'" );
