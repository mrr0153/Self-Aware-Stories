<?php
 ...
 { 
	...
	$mail->addAddress('pandubabu.j@zlap.ch', 'Self-Aware Stories');
	...
	<div id="wrapp">
		...
		<div id="content">
			...
			<div class="container"><br><br>
				...
				<?php if($_REQUEST['mssg']) $mssg=$_REQUEST['mssg']; if(isset($mssg)) echo "<h5 style='color:green;margin-bottom:10px;'>".$mssg."</h5>"; ?>
