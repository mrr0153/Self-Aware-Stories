...
<head>
<meta charset="utf-8">
<title>Self-Aware Stories : Plans & Pricing</title>
...
<div id="container">
	...
	<div id="wrapp">
		...
		<div id="main-navigation">
			...
			<div class="container">
				...
				<!--<li><a href="#"> Start Here </a></li> -->
					...
					<li id="current" ><a href="plans&pricing.php">Plans & Pricing</a></li>
		...
		<div id="content">
         <div class="container">
            <div style="height:auto;margin: 3% auto;">
                <img src="images/pricing.png"/>
				<p id="pricenote"><span style="color:red;font-weight:bold;">Note*</span> : Rates applicable for India, other countries please <a href="contactus.php"> contact us</a>  for quote.</p>		   
			</div>                                                                      
		 </div>	
		</div>
