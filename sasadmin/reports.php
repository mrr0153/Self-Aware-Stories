...
<body style="text-align:center">
	<br><br>
	<h2 style="color: #005292;">Questionnaire Reports</h2>
	<?php
					   						 
		$usrdata=mysql_query("select * from sas_users where user_id='$_REQUEST[uid]'");
		$resusrdata=mysql_fetch_array($usrdata);				
	?>
	<h4>User Name : <?php echo $resusrdata['username'];?></h4>
	...
	<?php
		...
		$qtndata=mysql_query("select * from sas_userqtnansws where uid='$_REQUEST[uid]'");
	...
	?>
		<table id="filelist" align="center" >
            <tr width="100%" style="background-color:#C1C6CE;color: #005292;">
				...
				<td width="15%" align="center">Not Answered</td>
			</tr>
     <?php					
    ...
    ?>       
		<p style="text-align:center;padding:60px 0px;">No Reports available at this point.</p> 
	<?php		
        } 
    ?>					
