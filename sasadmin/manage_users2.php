	...
	<?php if((!isset($_REQUEST['uid']))&&(!isset($_REQUEST['Call'])) )
		...
		<table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#B1B1B1">
          <tr>
			...
			<TD align="center" class="gray_txt"><img src="<?php if(isset($line['photopath']) and !empty($line['photopath']) ){echo  "../user_photos/".$line['photopath'];}else{ echo 'images/account.png'; }?>" width="60" height="50" ></TD>
			...
			<a href="manage_users.php?Call=edit&uid=<?php echo $line['user_id']?>" class="links">Add/Edit</a><span class="links" style="text-decoration:none">&nbsp;&nbsp;|&nbsp;</span>
